<template>
  <div class="container q-pa-md">
    ...
    <template v-else>
      <div class="row">
        <div class="col">
          <h4 class="text-center text-bold">Pengurus Pusat</h4>
          <div class="q-pa-xl" style="background-color: #e8f7fa">
            <p class="text-body1 text-center text-bold">
              BERDASARKAN SURAT KEPUTUSAN PENGURUS BESAR IKATAN DOKTER INDONESIA
              NOMOR : 00585/PB/A.4/09/2016 PENGESAHAN SUSUNAN PERSONALIA
              PENGURUS PUSAT PERHIMPUNAN DOKTER SPESIALIS ANESTESIOLOGI DAN
              TERAPI INTENSIF INDONESIA (PERDATIN) MASA BAKTI TAHUN 2022 - 2025
            </p>
          </div>
          ...
          <div class="justify-center">
            <div style="max-width: 800px; margin: auto">
              <p class="text-body1 text-center text-bold q-my-xl">
                SUSUNAN PENGURUS BESAR PERHIMPUNAN DOKTER SPESIALIS
