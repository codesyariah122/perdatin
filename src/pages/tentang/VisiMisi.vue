<template>
  <div class="container q-pa-md">
    ...
    <div v-else class="row">
      <div class="col">
        <h4 class="text-center text-bold">Visi & Misi</h4>

        <div class="row">
          <div class="col-xs-12 col-lg-8 q-pr-lg-xl">
            <h5 class="text-bold">Visi</h5>
            <div>
              <p class="text-body1 content-desc">{{ result.visi }}</p>
            </div>
            <h5 class="text-bold">Misi</h5>
            <div>
              <p class="text-body1 content-desc">{{ result.misi }}</p>
            </div>
          </div>
